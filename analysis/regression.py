...
def run_ols_models(df):
    ...
    with open(f"{PROPERTY["MODELS_DIR"]}/model1_city_center.txt", "w") as f:
        f.write(model1.summary().as_text())
    print(f"Regression model 1 saved: {PROPERTY["MODELS_DIR"]}/model1_city_center.txt")
    print()
    ...
    with open(f"{PROPERTY["MODELS_DIR"]}/model2_landmark.txt", "w") as f:
        f.write(model2.summary().as_text())
    print(f"Regression model 2 saved: {PROPERTY["MODELS_DIR"]}/model2_landmark.txt")
    print()
    ...
    with open(f"{PROPERTY["MODELS_DIR"]}/model3_full.txt", "w") as f:
        f.write(model3.summary().as_text())
    print(f"Regression model 3 saved: {PROPERTY["MODELS_DIR"]}/model3_full.txt")
    print()
    ...
    with open(f"{PROPERTY["MODELS_DIR"]}/model4_interaction.txt", "w") as f:
        f.write(model4.summary().as_text())
    print(f"Regression model 4 saved: {PROPERTY["MODELS_DIR"]}/model4_interaction.txt")
    print()
